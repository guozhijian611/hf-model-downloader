...
test: install ## Run tests (fast smoke tests by default)
	@echo "Running tests..."
	@$(UV) run pytest tests/test_hf_xet.py tests/test_hf_hub_env.py tests/test_hf_repo_type.py tests/test_download_process.py tests/test_proxy_env.py tests/test_version.py tests/test_update_check.py -v
